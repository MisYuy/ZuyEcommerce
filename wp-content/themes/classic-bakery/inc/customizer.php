...
function classic_bakery_customize_register( $wp_customize ) {
	...
	// woocommerce section
	$wp_customize->add_section('classic_bakery_woocommerce_page_settings', array(
		'title'    => __('WooCommerce Page Settings', 'classic-bakery'),
		'priority' => null,
		'panel'    => 'woocommerce',
	));

    // shop page sidebar alignment
    $wp_customize->add_setting('classic_bakery_shop_page_sidebar_position', array(
		'default'           => 'Right Sidebar',
		'sanitize_callback' => 'classic_bakery_sanitize_choices',
	));
	$wp_customize->add_control('classic_bakery_shop_page_sidebar_position',array(
		'type'           => 'radio',
		'label'          => __('Shop Page Sidebar', 'classic-bakery'),
		'section'        => 'classic_bakery_woocommerce_page_settings',
		'choices'        => array(
			'Left Sidebar'  => __('Left Sidebar', 'classic-bakery'),
			'Right Sidebar' => __('Right Sidebar', 'classic-bakery'),
		),
	));
	...
	//Site Layout Section
	$wp_customize->add_section('classic_bakery_site_layoutsec',array(
		'title'	=> __('Manage Site Layout Section ','classic-bakery'),
		'description' => __('<p class="sec-title">Manage Site Layout Section</p>','classic-bakery'),
		'priority'	=> 1,
	...
	$wp_customize->add_control( 'classic_bakery_preloader', array(
	   'section'   => 'classic_bakery_site_layoutsec',
	...
	$wp_customize->add_setting('classic_bakery_button_link_slider',array(
        'default'=> '',
        'sanitize_callback' => 'esc_url_raw'
    ));
    $wp_customize->add_control('classic_bakery_button_link_slider',array(
        'label' => esc_html__('Add Button Link','classic-bakery'),
        'section'=> 'classic_bakery_one_cols_section',
        'type'=> 'url'
    ));

    //Slider height
    $wp_customize->add_setting('classic_bakery_slider_img_height',array(
        'default'=> '',
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('classic_bakery_slider_img_height',array(
        'label' => __('Slider Image Height','classic-bakery'),
        'description'   => __('Add the slider image height here (eg. 600px)','classic-bakery'),
        'input_attrs' => array(
            'placeholder' => __( '500px', 'classic-bakery' ),
        ),
        'section'=> 'classic_bakery_one_cols_section',
        'type'=> 'text'
    ));
	...
	$wp_customize->add_setting( 'classic_bakery_slider_settings_upgraded_features',array(
	  'sanitize_callback' => 'sanitize_text_field'
	));
	$wp_customize->add_control('classic_bakery_slider_settings_upgraded_features', array(
	    'type'=> 'hidden',
	    'description' => "<span class='customizer-upgraded-features'>Unlock Premium Customization Features:
	        <a target='_blank' href='". esc_url('https://www.theclassictemplates.com/products/bakery-wordpress-theme/') ." '>Upgrade to Pro</a></span>",
	    'section' => 'classic_bakery_one_cols_section'
	));
	...
	$wp_customize->add_setting('classic_bakery_procat_show',array(
		'default' => false,
		'sanitize_callback' => 'classic_bakery_sanitize_checkbox',
		'capability' => 'edit_theme_options',
	));
	$wp_customize->add_control( 'classic_bakery_procat_show', array(
	   'settings' => 'classic_bakery_procat_show',
	...
	$wp_customize->add_setting( 'classic_bakery_secondsec_settings_upgraded_features',array(
	  'sanitize_callback' => 'sanitize_text_field'
	));
	$wp_customize->add_control('classic_bakery_secondsec_settings_upgraded_features', array(
	  'type'=> 'hidden',
	  'description' => "<span class='customizer-upgraded-features'>Unlock Premium Customization Features:
	      <a target='_blank' href='". esc_url('https://www.theclassictemplates.com/products/bakery-wordpress-theme/') ." '>Upgrade to Pro</a></span>",
	  'section' => 'classic_bakery_category'
   ...
   // Add Settings and Controls for Post Layout
	...
	$wp_customize->add_setting('classic_bakery_blog_post_thumb',array(
        'sanitize_callback' => 'classic_bakery_sanitize_checkbox',
        'default'           => 1,
    ));
    $wp_customize->add_control('classic_bakery_blog_post_thumb',array(
        'type'        => 'checkbox',
        'label'       => esc_html__('Show / Hide Blog Post Thumbnail', 'classic-bakery'),
        'section'     => 'classic_bakery_blog_post_settings',
    ));
	...
	$wp_customize->add_setting('classic_bakery_footer_bg_image',array(
        'default'   => '',
        'sanitize_callback' => 'esc_url_raw',
    ));
    $wp_customize->add_control( new WP_Customize_Image_Control($wp_customize,'classic_bakery_footer_bg_image',array(
        'label' => __('Footer Background Image','classic-bakery'),
    ...
    $wp_customize->add_setting('classic_bakery_scroll_position',array(
        'default' => 'Right',
        'sanitize_callback' => 'classic_bakery_sanitize_choices'
    ));
    $wp_customize->add_control('classic_bakery_scroll_position',array(
        'type' => 'radio',
        'section' => 'classic_bakery_footer',
        'label'	 	=> __('Scroll To Top Positions','classic-bakery'),
        'choices' => array(
            'Right' => __('Right','classic-bakery'),
            'Left' => __('Left','classic-bakery'),
            'Center' => __('Center','classic-bakery')
        ),
    ) );

    $wp_customize->add_setting( 'classic_bakery_footer_settings_upgraded_features',array(
	  'sanitize_callback' => 'sanitize_text_field'
	));
	$wp_customize->add_control('classic_bakery_footer_settings_upgraded_features', array(
	    'type'=> 'hidden',
	    'description' => "<span class='customizer-upgraded-features'>Unlock Premium Customization Features:
	        <a target='_blank' href='". esc_url('https://www.theclassictemplates.com/products/bakery-wordpress-theme/') ." '>Upgrade to Pro</a></span>",
	    'section' => 'classic_bakery_footer'
